...
import "./SessionKeyAccount.sol";

/**
 * A sample factory contract for SessionKeyAccount
...
contract SessionKeyAccountFactory {
    ...
    function createAccount(
        ...
        ret = SessionKeyAccount(
            payable(
                new ERC1967Proxy{salt: bytes32(salt)}(
                    address(accountImplementation),
                    abi.encodeCall(SessionKeyAccount.initialize, (owner))
                )
            )
        );
    }
